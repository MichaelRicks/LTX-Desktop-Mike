...
class ImageGenerationHandler(StateHandlerBase):
    ...
    def _edit(
        ...
        *,
        ...
        try:
            self._generation.raise_if_cancelled()
            self._pipelines.load_image_generation_pipeline_to_gpu("z-image-turbo")
            self._generation.start_generation(generation_id)
    ...
    def edit_image(
        ...
        image_generation_pipeline = self._pipelines.load_image_generation_pipeline_to_gpu("z-image-turbo")
    ...
    def _run_api_batch(
        ...
        try:
            ...
            return GenerateImageCompleteResponse(status="complete", image_paths=[str(p) for p in output_paths], seed=seed)
